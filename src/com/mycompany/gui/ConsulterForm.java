 ...
 * @author tahaj
 */
public class ConsulterForm extends BaseForm {
    
    Form current;
    public ConsulterForm (Resources res)
    {
  ...
  swipe.setUIID("Container");
        ...
        btnshow.addActionListener((e) -> {
          ...
          //  ServiceTicket.getInstance().AfficherCons(Integer.parseInt(String.valueOf(userid.getText())));
           
            new DetTicketForm(res,Integer.parseInt(String.valueOf(userid.getText()))).show();
