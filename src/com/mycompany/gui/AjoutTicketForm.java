...
public class AjoutTicketForm extends BaseForm {
  ...
  swipe.setUIID("Container");
        ...
        RadioButton mesListes = RadioButton.createToggle("My Tickes", barGroup);
        ...
        addStringValue("SUBJECT",subject);
         ...
         TextField description = new TextField("", "write description.. ");
        description.setUIID("TextFieldBlack");
        addStringValue("DESCRIPTOION",description);
        ...
        Button btnAjouter = new Button("SEND");
        ...
        btnAjouter.addActionListener((e) -> {
            ...
            try{
                ...
                if( id.getText().equals("") || userid.getText().equals("")|| subject.getText().equals("")|| description.getText().equals(""))
                {
                ...
                else
                {
                    ...
                    Ticket t = new Ticket(Integer.parseInt(String.valueOf(id.getText())),Integer.parseInt(String.valueOf(userid.getText())),String.valueOf(subject.getText()),String.valueOf(description.getText()),"","");


                    System.out.println("data Ticket == "+t);

                    ServiceTicket.getInstance().ajoutTicket(t);
