 ...
 * @author asus
 */
public class offerManager extends BaseForm{
     Form current;
    public offerManager(Resources res){
     super("Newsfeed",BoxLayout.y());
        ...
        addTab(swipe,s1, res.getImage("breadcumb3.jpg"),"","",res);
        ...
        RadioButton offerslist = RadioButton.createToggle("Offers list", barGroup);
        offerslist.setUIID("SelectBar");
        ...
        addoffer.setUIID("SelectBar");
         ...
         offerslist.addActionListener((e) -> {
        ...
        add(LayeredLayout.encloseIn(
                GridLayout.encloseIn(2, offerslist, addoffer),
                FlowLayout.encloseBottom(arrow)
        ));

        offerslist.setSelected(true);
        arrow.setVisible(false);
        addShowListener(e -> {
            arrow.setVisible(true);
            updateArrowPosition(offerslist, arrow);
        });
        bindButtonSelection(offerslist, arrow);
        ...
        ArrayList<Offer>list = serviceOffer.getInstance().manageOffers();
 ...
 swipe.addTab("",res.getImage("logoo.png"), page1);
    ...
    private void addButton(Image img,Offer ofs , Resources res) {
      ...
      lModifier.addPointerPressedListener(l ->  {
        ...
        Button btnAjouter = new Button("Edit");
